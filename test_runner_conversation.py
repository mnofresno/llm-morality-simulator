...
def test_runner_show_conversation_with_all_entry_types():
    ...
    result = {
        ...
        'conversation_history': [
            ...
            {'step': 3, 'type': 'tool_call', 'tool_name': 'test_tool', 'arguments': {'key': 'value'}, 'timestamp': '2024-01-01T00:00:03'},
            {'step': 4, 'type': 'tool_result', 'tool_name': 'test_tool', 'result': {'status': 'ok'}, 'timestamp': '2024-01-01T00:00:04'},
            {'step': 5, 'type': 'tool_error', 'tool_name': 'error_tool', 'error': 'Error message', 'timestamp': '2024-01-01T00:00:05'},
