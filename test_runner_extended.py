...
def test_runner_show_conversation_progress_with_tools():
    ...
    result = {
        ...
        'scenario': 'test',
        'conversation_history': [
            {'step': 1, 'type': 'tool_call', 'tool_name': 'test_tool', 
             'arguments': {'action': 'positive'}, 'timestamp': '2024-01-01T00:00:00'},
            {'step': 2, 'type': 'tool_result', 'tool_name': 'test_tool',
             'result': {'executed': True, 'action': 'positive'}, 'timestamp': '2024-01-01T00:00:01'}
        ]
    }
