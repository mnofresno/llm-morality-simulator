...
class ScenarioRegistry:
        ...
        for file_path in scenario_files:
            ...
            try:
                ...
                for name, obj in inspect.getmembers(module, inspect.isclass):
                    if issubclass(obj, BaseScenario) and obj is not BaseScenario and obj.__module__ == module.__name__:
    ...
    def get_scenario_metadata(cls, identifier: str) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"name": scenario_class.__name__, "class": scenario_class.__name__}
