...
class ExperimentStatistics:
    ...
    def _get_storage(self):
        ...
        if self.storage_backend is None:
            ...
            backend_map = {"duckdb": StorageBackend.DUCKDB, "sqlite": StorageBackend.SQLITE, "jsonl": StorageBackend.JSONL}
    ...
    def get_example_responses(
        self, results: List[Dict[str, Any]], decision_key: str, decision_value: Any, n_examples: int = 5
    ) -> List[Dict[str, Any]]:
        """
