...
def test_show_conversation_progress_with_all_types():
    ...
    result = {
        ...
        "decisions": {"harm_decision": False, "self_preservation": True, "determinative_action": "negative"},
        "conversation_history": [
            ...
            {"step": 2, "type": "llm_response", "content": "Model response text", "timestamp": "2024-01-01T00:00:02Z"},
            {
                "step": 3,
                "type": "tool_call",
                "tool_name": "determinative_action",
                "arguments": {"action": "negative"},
...
def test_show_conversation_progress_with_decision_summary():
    ...
    result = {
        ...
        "conversation_history": [{"step": 0, "type": "user_prompt", "content": "Test", "timestamp": "2024-01-01T00:00:00"}],
    }
