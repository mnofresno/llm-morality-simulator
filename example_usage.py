...
if __name__ == "__main__":
    ...
    print("=" * 60)
    print("\nNote: Update model_path in example_single_run() with your GGUF model file.")
    print("\nChoose an example to run:")
    print("1. Run a single experiment (requires model file)")
    print("2. Load existing results (requires results/*.jsonl files)")
    print("3. Both")
