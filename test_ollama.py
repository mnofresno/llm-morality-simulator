...
def test_simple_inference(model: OllamaLLM):
    ...
    try:
        ...
        inference_result = model.infer(prompt=prompt, temperature=0.7, top_p=0.9, max_tokens=50)
...
def test_experiment_run(model: OllamaLLM):
    ...
    try:
        ...
        results = runner.run_experiment(
            model=model, scenario=scenario, n_runs=3, seed=42, temperature=0.7, top_p=0.9, max_tokens=256, progress_bar=True
        )
