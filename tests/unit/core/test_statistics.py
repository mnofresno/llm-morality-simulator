    ...
    mock_results = [
        {
            ...
            "decisions": {"harm_decision": i % 2 == 0, "self_preservation": i % 3 == 0, "deception": False},
            "metadata": {},
        }
        for i in range(10)
    ]
...
def test_results_to_dataframe():
    ...
    mock_results = [
        {"run_id": 0, "scenario": "test", "response": "Test response", "decisions": {"harm_decision": True}, "metadata": {}},
        {
            "run_id": 1,
            "scenario": "test",
...
def test_get_decision_distribution():
    ...
    mock_results = [{"run_id": i, "decisions": {"test_decision": i % 2 == 0}, "metadata": {}} for i in range(10)]
...
def test_statistics_confidence_intervals():
    ...
    mock_results = [
        {"run_id": i, "scenario": "test", "response": f"Response {i}", "decisions": {"harm_decision": i < 5}, "metadata": {}}
        for i in range(10)
    ]
