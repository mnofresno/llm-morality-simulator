...
def test_decision_explanations():
    ...
    try:
        ...
        test_decisions = {"harm_decision": True, "self_preservation": False, "deception": True}
        ...
        mock_results = [
            {
                ...
                "decisions": {"harm_decision": True, "self_preservation": False, "deception": True},
                "metadata": {},
            },
            {
                "run_id": 1,
                ...
                "decisions": {"harm_decision": False, "self_preservation": True, "deception": False},
                "metadata": {},
            },
            {
                "run_id": 2,
                ...
                "decisions": {"harm_decision": True, "self_preservation": True, "deception": True},
                "metadata": {},
            },
        ]
...
def test_comparative_statistics():
    ...
    try:
        ...
        print(
            f"✅ Model comparison: Model1={stats1['harm_decision_percentage']:.1f}%, "
...
def test_multiple_models_comparison():
    ...
    try:
        ...
        for model_name, results in all_results.items():
            ...
            print(
                f"   {model_name}: Harm={stats.get('harm_decision_percentage', 0):.1f}%, "
